...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fukapp_competition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('comp_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ...
            ('promoter', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('eligibility', self.gf('django.db.models.fields.CharField')(default='E', max_length=1)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('collect_emails', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('entry_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('fukapp', ['Competition'])

        # Adding model 'CompetitionEntry'
        db.create_table('fukapp_competitionentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fukapp.Competition'])),
        ...
        db.send_create_signal('fukapp', ['CompetitionEntry'])

        # Adding model 'ArchiveContent'
        db.create_table('fukapp_archivecontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('ogauthor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ogtype', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('terms', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('fukapp', ['ArchiveContent'])

        # Adding model 'Affiliate'
        db.create_table('fukapp_affiliate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('linkcode', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('fukapp', ['Affiliate'])


    def backwards(self, orm):
        
        # Deleting model 'Competition'
        db.delete_table('fukapp_competition')

        # Deleting model 'CompetitionEntry'
        db.delete_table('fukapp_competitionentry')

        # Deleting model 'ArchiveContent'
        db.delete_table('fukapp_archivecontent')

        # Deleting model 'Affiliate'
        db.delete_table('fukapp_affiliate')
