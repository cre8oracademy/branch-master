...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompetitionEntry.mailingpref'
        db.add_column('fukapp_competitionentry', 'mailingpref', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CompetitionEntry.mailingpref'
        db.delete_column('fukapp_competitionentry', 'mailingpref')
